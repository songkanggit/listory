...
public class NetCacheUtils {
    ...
    public void getBitmapFromNet(ImageView imageView, String url, ImageLoader.ImageDownLoadCallback callback) {
        ...
        WeakReference<ImageLoader.ImageDownLoadCallback> callbackRf = new WeakReference<>(callback);
        new BitmapTask().execute(viewRef, url, callbackRf);//启动AsyncTask
    }
    ...
    class BitmapTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Object[] params) {
            ...
            mCallback = (WeakReference<ImageLoader.ImageDownLoadCallback>) params[2];
