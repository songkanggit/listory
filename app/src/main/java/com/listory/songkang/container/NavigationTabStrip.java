...
package com.listory.songkang.container;
...
public class NavigationTabStrip extends View implements ViewPager.OnPageChangeListener {
    private static final String TAG = NavigationTabStrip.class.getSimpleName();
    ...
    public NavigationTabStrip(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        try {
            ...
            setStripColor(typedArray.getColor(
                    R.styleable.NavigationTabStrip_nts_strip_color, DEFAULT_ACTIVE_COLOR
                    )
            );
